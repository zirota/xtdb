= Installation
:page-aliases: 1.19.0@reference::installation.adoc
...
You can also build custom XTDB JARs with your choice of modules - see the https://juxt.pro/blog/crux-build[XTDB build,window=_blank] blog for more details.
...
`docker run -p 3000:3000 juxt/xtdb-in-memory:1.19.0`

Again, this opens up an HTTP server at http://localhost:3000[window=_blank].

Likewise, you can build custom XTDB Docker images - see the https://juxt.pro/blog/crux-build[XTDB build,window=_blank] blog for more details.

...
[source,kotlin]
----
include::example$src/docs/Install.kt[tags=imports]

include::example$src/docs/Install.kt[tags=main,indent=0]
====
...
`docker run -p 3000:3000 juxt/crux-in-memory:21.01-1.14.0`

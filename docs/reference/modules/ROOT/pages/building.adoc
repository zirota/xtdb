...
To run the clojure uberjar, use the following command `java -jar crux.jar`. This will now start up a similar node to `crux-standalone` above - with the addition of persistent storage.
